...
public class trading extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        sellBtn = getView().findViewById(R.id.sellRiceBtn);
       ...
       findBtn.setOnClickListener(new View.OnClickListener() {
        ...
        buyBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(sellQuantity>0){ //to handle less than zero quantities
                    Log.i("ndboy", "It got here. hurray!");
                    if(buyQuantity<sellQuantity) {
                        Random rand = new Random();
                        String newID = Constants.RICE_ID_PREFIX + String.valueOf(rand.nextInt(Constants.RANDOM_NUM_UPPER_BOUND));
                        mViewModel.buyRicePortion(newID, "PAUL", buyQuantity);
                    } else if(buyQuantity==sellQuantity) mViewModel.buyRiceAll("JERRY");
                    else{
                        Toast.makeText(getContext(),"Please review your buy quantity", Toast.LENGTH_SHORT);
                    }
                    Toast.makeText(getContext(),"Please review your buy quantity", Toast.LENGTH_SHORT);
                }
            }
