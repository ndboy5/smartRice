...
if [ "$CC_SRC_PATH" = "NA" ]; then
	...
	elif [ "$CC_NAME" = "document" ]; then
		echo $'\e[0;32m'document$'\e[0m' chaincode
		CC_SRC_PATH="../chaincode/document"
	elif [ "$CC_NAME" = "publisher" ]; then
		echo $'\e[0;32m'publisher$'\e[0m' chaincode
		CC_SRC_PATH="../chaincode/publisher"
	elif [ "$CC_NAME" = "requester" ]; then
		echo $'\e[0;32m'requester$'\e[0m' chaincode
		CC_SRC_PATH="../chaincode/requester"
	else
