/**
 * This script is used to setup the connection to the block chain 
 * It should be ran after setting up the block chain network
 * t should be only ran once before running the server.js file
 */
'use strict';
